    ...
    <>
      <div className="relative h-full w-full overflow-hidden bg-secondary-500 pt-12">
        ...
        <div className="relative rounded-md bg-secondary-400 p-3">
          <div className="flex flex-col items-start gap-y-1 p-3">
            <h1 className="font-literata text-2xl text-white">Catatan</h1>
            <h1 className="text-md font-louis font-thin text-white">
              Untuk restoran jika kamu ingin memberikan permintaan.
            </h1>
            <input
              type="textarea"
              className={`peer block w-full appearance-none rounded-md border-2 border-secondary-200 bg-transparent py-2.5 px-0 pl-3 text-others-white focus:border-primary-300 focus:outline-none focus:ring-0 ${
                count > 300 ? "focus:border-failed" : "focus:border-primary-300"
              }`}
            ...
            <h1
              className={`${
                count > 300 ? "font-louis text-sm text-failed" : "hidden"
              }`}
            >
              Panjang melebihi ketentuan
            </h1>
            <h1 className="font-louis text-white">{count}/300</h1>
          </div>
        </div>
        <Pedas />
        <Toping />
