    ...
    <>
      ...
      >
        ...
        <div className={`flex items-center`}>
          ...
          <span className="ml-3 text-others-white">
            {page == "add" ? "Tambah" : "Edit"} Menu
          </span>
        </div>
        {/* Unggah Foto Menu */}
            ...
            render={({ field: { onChange }, fieldState }) => (
              <>
                ...
                {fieldState.error && (
                  <span
                    role="alert"
                    className="mt-[2em] font-louis text-sm text-failed"
                  >
        ...
        <div>
          ...
          {errors.nama && (
            <span className="mt-[.25em] block text-start font-louis text-sm text-failed">
              {errors.nama.type === "required" && <>{errors.nama.message}</>}
              {errors.nama.type === "minLength" &&
                "Nama menu minimal 5 karakter"}
            </span>
          )}
        </div>
        {/* Harga */}
        <div>
          ...
          <div className="relative">
            <input
              ...
              autoComplete={"off"}
              type="number"
              className={`w-full text-ellipsis border-b bg-transparent py-2 pl-[1.25em] font-louis text-[18px] font-light text-others-white duration-500 focus:border-b focus:border-others-white focus:outline-none ${
        ...
        <div>
          ...
          <div className="relative">
            <textarea
              ...
              autoComplete={"off"}
              maxLength={150}
              className={`mt-2 h-[120px] w-full rounded-md border bg-transparent p-2 text-justify font-louis text-[18px] font-light text-others-white duration-500 focus:border-b focus:border-others-white focus:outline-none ${"border-others-white"}`}
            />
