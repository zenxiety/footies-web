            ...
            <div className="flex flex-row items-start justify-between">
              ...
              <label>
                ...
                <span // custom checkbox style
                  className={
                    "flex h-[20px] w-[20px] scale-100 items-center justify-center  rounded-[4px] bg-white peer-checked:scale-[0.8] peer-checked:bg-[#F4B829]  peer-checked:pt-0 peer-checked:outline-double peer-checked:outline-[#F4B829] hover:cursor-pointer"
                  }
                />
              </label>
            </div>
