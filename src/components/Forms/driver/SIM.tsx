  ...
  return (
    <>
      <form
        ...
        className="relative z-10 flex w-screen flex-col items-center justify-between px-8 pt-20 xs:w-[500px]"
      >
        <div>
          <h3 className="px-10">Surat Izin Mengemudi (SIM)</h3>
          <div className="mx-auto mt-8 w-fit rounded-md border-[6px] border-primary-300 bg-white/10">
            <Image src="/signup/sim.png" alt="" width={260} height={170} />
          </div>
          <p
            className={`mt-10 mb-1 mr-auto text-start text-[15px] font-medium  duration-500
          ${getValues("sim") ? "text-primary-300" : "text-secondary-100"}`}
          >
